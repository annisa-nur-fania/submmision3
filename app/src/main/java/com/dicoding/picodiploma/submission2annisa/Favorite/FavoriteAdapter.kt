...
import com.dicoding.picodiploma.submission2annisa.CustomeOnItemClickListener
    ...
    inner class FavoriteHolder(itemView: ItemRowAvatarBinding) :
        ...
        fun bind(data: FavoriteData) {
            with(itemView) {
                ...
                binding.layout.setOnClickListener(CustomeOnItemClickListener(adapterPosition,
